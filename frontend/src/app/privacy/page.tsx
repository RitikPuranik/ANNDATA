    ...
    <main className="min-h-screen bg-background">
      <article className="mx-auto max-w-4xl px-5 py-12 sm:px-8">
        ...
        <div className="mt-10 space-y-8 text-sm leading-7 text-muted-foreground">
          <section><h2 className="text-xl font-bold text-foreground">1. Scope</h2><p className="mt-3">This Privacy Policy explains how Anndata/Anndata may collect, use, store and protect information when you use the website, application, APIs and WhatsApp assistant.</p></section>
          ...
          <section><h2 className="text-xl font-bold text-foreground">3. Public WhatsApp conversations</h2><p className="mt-3">The public WhatsApp assistant can be used without registering a Anndata account. Guest conversations are kept separate from private farmer account data. Public buyer previews are intentionally limited and do not expose private contact information or protected buyer pricing.</p></section>
