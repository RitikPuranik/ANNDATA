    ...
    <main className="min-h-screen bg-background">
      <article className="mx-auto max-w-4xl px-5 py-12 sm:px-8">
        ...
        <div className="mt-10 space-y-8 text-sm leading-7 text-muted-foreground">
          <section><h2 className="text-xl font-bold text-foreground">1. About these terms</h2><p className="mt-3">These Terms & Conditions govern your use of the Anndata/ANNDATA website, application, APIs and related services. By using the service, you agree to these terms. If you do not agree, do not use the service.</p></section>
          ...
          <section><h2 className="text-xl font-bold text-foreground">7. WhatsApp</h2><p className="mt-3">The WhatsApp assistant is an additional interface to supported Anndata features. Public conversations may be available without a ANNDATA account, while private account information requires account linking and authorization. WhatsApp use is also subject to Meta&apos;s applicable terms and policies.</p></section>
